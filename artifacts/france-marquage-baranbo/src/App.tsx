...
const siteTranslations: Record<Language, SiteCopy> = {
  EN: {
    ...
    hero: {
      ...
      since: 'C.F.M.B. / Since 2008 / Casablanca',
    ...
    about: {
      ...
      visibilityText: 'Reflective marking solutions improve visibility after dark, helping drivers and pedestrians navigate with greater clarity.',
  ...
  FR: {
    ...
    hero: {
      ...
      since: 'C.F.M.B. / Depuis 2008 / Casablanca',
    ...
    about: {
      ...
      visibilityText: 'Nos solutions de marquage rétroréfléchissant améliorent la visibilité après la tombée de la nuit et facilitent les déplacements des conducteurs comme des piétons.',
  ...
  AR: {
    ...
    hero: {
      kicker: 'الدقة على أرض الواقع',
      titleFirst: 'نرسم',
      titleSecond: 'طريق التقدم.',
      description: 'حلول احترافية لتخطيط الطرق وسلامة الحركة، مصممة من أجل الوضوح والمتانة والأداء اليومي.',
      quote: 'اطلب عرضاً',
      explore: 'استكشف خدماتنا',
      since: 'C.F.M.B. / منذ 2008 / الدار البيضاء',
      note: 'خطوط واضحة في كل موقع.',
      noteAccent: 'كل متر مهم.',
    },
    about: {
      kicker: 'من نحن',
      titleFirst: 'تخطيط واضح.',
      titleSecond: 'طرق أكثر أماناً.',
      ...
      precisionText: 'نُعد كل مشروع وننفذه بعناية لنقدم نتائج نظيفة ودقيقة ومتناسقة.',
      visibilityLabel: 'وضوح نهاراً وليلاً',
      visibilityText: 'تُحسّن حلول التخطيط العاكسة الرؤية بعد حلول الظلام، وتساعد السائقين والمشاة على التنقل بوضوح أكبر.',
